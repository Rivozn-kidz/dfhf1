    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-background">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 2px 2px, hsl(var(--tech-border)) 1px, transparent 0)",
      ...
      <div className="container relative z-10 px-6 py-20 mx-auto">
        <div className="max-w-4xl animate-fade-in-up">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl leading-relaxed">
            At Suko Devs Crew, we craft cutting-edge digital solutions that
            push the boundaries of innovation. From immersive 3D experiences to
            revolutionary software, we turn your vision into reality.
          </p>
